...
public class LaborantLoginPostForm {
    ...
    public LaborantLoginPostForm(String identificationNumber, String email, String hospitalId, String password) {
    ...
    public void setIdentificationAndPassword(Boolean identificationAndPassword) {
        this.identificationAndPassword = identificationAndPassword;
    }
    ...
    public void setHospitalIdAndPassword(Boolean hospitalIdAndPassword) {
        this.hospitalIdAndPassword = hospitalIdAndPassword;
    }
    ...
    public void setEmailAndPassword(Boolean emailAndPassword) {
